...
class roadlines:
	...
	def movement(roadx, roady):
		pygame.draw.rect(gameDisplay, white, [roadx, roady, 10, 50])
...
def game_loop():
	...
	# Roadlines
	a = roadlines(roadline_startx, roadline_starty)
	b = roadlines(roadline_startx, (roadline_starty + (display_height - 300)))
	c = roadlines(roadline_startx, (roadline_starty + (display_height - 450)))

	b.movement(roadline_startx, roadline_starty)
	c.movement(roadline_startx, roadline_starty)
	...
	while not gameExit:
		...
		if a.roadline_starty > display_height:
			a.roadline_starty = 0 
